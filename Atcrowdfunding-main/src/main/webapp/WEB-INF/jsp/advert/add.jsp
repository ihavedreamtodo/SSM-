			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="advertForm" method="post" action="" enctype="multipart/form-data">
				  ...
				  <button id="addRet" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</form>
			  </div>
			</div>
        </div>
      ...
      <script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        ...
        <script type="text/javascript">
            ...
            $("#addRet").click(function(){
            	$("#advertForm")[0].reset();//这里将JQuery函数转化未dom函数，因为JQuery没有reset方法
            });
