			  ...
			  <div class="panel-body">
				<form role="form" class="form-inline">
				  <div class="form-group">
					...
					<select id="leftToRightList" class="form-control" multiple size="10" style="width:150px;overflow-y:auto;">
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select id="rightToLeftList" class="form-control" multiple size="10" style="width:100px;overflow-y:auto;">
       ...
       <script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        ...
        <script type="text/javascript">
            ...
            $("#leftToRight").click(function(){
            	var selectedOption = $("#leftToRightList option:selected");
            //法1
            /* 	$("#rightToLeftList").append(selectedOption.clone());
            	selectedOption.remove();
            	 */
            	//上面是实现了js页面的变化，下面利用好ajax来实现数据库的变化
            	var jsonObj = {
            		userid : "${param.id}"	
            	};
          ...
          /*   取消角色 */
            $("#rightToLeft").click(function(){
            	var selectedOption = $("#rightToLeftList option:selected");
            	  //法1
                /* 	$("#rightToLeftList").append(selectedOption.clone());
                	selectedOption.remove();
                	 */
                	...
                	$.ajax({
                		...
                		success : function(result){
                			if(result.success) {
                				$("#leftToRightList").append(selectedOption);selectedOption.remove();
                		...
                		error : function(){
                			layer.msg("取消失败!", {time:1000, icon:5, shift:6});
            	...
            	/* //法2 
            	$("#leftToRightList").append(selectedOption); */
