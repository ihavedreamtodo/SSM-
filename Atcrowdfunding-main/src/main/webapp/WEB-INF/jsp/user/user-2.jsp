	...
	<script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function deleteUser(id,username){
            	...
            	layer.confirm("是否确定删除用户{"+username+"}",  {icon: 3, title:'提示'}, function(cindex){
            ...
            var tbadycheckedbox = $("tbody tr td input[type='checkbox']");
            ...
            $("#deleteBatch").click(function(){
    			...
    			layer.confirm("是否确认删除这些用户",  {icon: 3, title:'提示'}, function(cindex){
